...
function loadHomePage() {
  ...
  const aboutUsText = createTextElement('p', "At The 5th Chops, we pride ourselves on offering a culinary experience like no other. Our chef's passion for food and dedication to quality ensure that every dish we serve is a masterpiece.", 'about-us-text');
